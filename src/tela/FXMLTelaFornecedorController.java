...
public class FXMLTelaFornecedorController implements Initializable {
    ...
    private void actionBtConsultar(ActionEvent event) {
        ...
        clikbotaoMenuPrincipal("/tela/fornecedor/FXMLTelaFornecedorConsultar.fxml", 3);
    }

    @FXML
    private void actionBtAtualizar(ActionEvent event) {

        clikbotaoMenuPrincipal("/tela/fornecedor/FXMLTelaFornecedorAtualizar.fxml", 1);
    }

    @FXML
    private void actionBtCatastrar(ActionEvent event) {

        clikbotaoMenuPrincipal("/tela/fornecedor/FXMLTelaFornecedorCadastrar.fxml", 2);
    }
    ...
    public void clikbotaoMenuPrincipal(String nomeTela, int botao) {
        ...
        try {
            ...
            Util.setTelaFornecedorCarregada(this);
