 ...
 * @author drico
 */
public class FXMLTelaEquipamentoController implements Initializable {
 ...
 @FXML
    private void actionBtConsultar(ActionEvent event) {
        ...
        clikbotaoMenuPrincipal("/tela/equipamento/FXMLTelaEquipamentoConsultar.fxml", 3);
    }

    @FXML
    private void actionBtAtualizar(ActionEvent event) {

        clikbotaoMenuPrincipal("/tela/equipamento/FXMLTelaEquipamentoAtualizar.fxml", 1);
    }

    @FXML
    private void actionBtCatastrar(ActionEvent event) {

        clikbotaoMenuPrincipal("/tela/equipamento/FXMLTelaEquipamentoCadastrar.fxml", 2);
    }
    ...
    public void clikbotaoMenuPrincipal(String nomeTela, int botao) {
        ...
        try {
            ...
            Util.setTelaEquipamentoCarregada(this);
